...
void CX86Assembler::VaddsdEq(XMMREGISTER dst, XMMREGISTER src1, const CAddress& src2)
{
	WriteVexVoOp(VEX_OPCODE_MAP_F2, 0x58, dst, src1, src2);
}

void CX86Assembler::VsubsdEq(XMMREGISTER dst, XMMREGISTER src1, const CAddress& src2)
{
	WriteVexVoOp(VEX_OPCODE_MAP_F2, 0x5C, dst, src1, src2);
}
...
void CX86Assembler::VpsllqVo(XMMREGISTER dst, XMMREGISTER src, uint8 amount)
{
	WriteVexShiftVoOp(0x73, 0x06, dst, src, amount);
}

void CX86Assembler::VpsrlqVo(XMMREGISTER dst, XMMREGISTER src, uint8 amount)
{
...
void CX86Assembler::VpextrdEd(const CAddress& dst, XMMREGISTER src, uint8 idx)
{
	WriteVexVoOp(VEX_OPCODE_MAP_66_3A, 0x16, src, CX86Assembler::xMM0, dst);
	WriteByte(idx);
}

void CX86Assembler::VpbroadcastbVo(XMMREGISTER dst, const CAddress& src)
{
	WriteVexVoOp(VEX_OPCODE_MAP_66_38, 0x78, dst, CX86Assembler::xMM0, src);
}
...
void CX86Assembler::VcmpeqpsVo(XMMREGISTER dst, XMMREGISTER src1, const CAddress& src2)
{
	VcmppsVo(dst, src1, src2, SSE_CMP_EQ);
}
