...
namespace Jitter
{
	...
	protected:
		...
		struct FP64OP_SQRT : public FP64OP_BASE
		{
			static OpEqAvxType OpEqAvx() { return &CX86Assembler::VsqrtsdEq; }
		};
		...
		struct MDOP_CMPEQS : public MDOP_BASE
		{
			static OpVoType OpVo() { return &CX86Assembler::CmpeqpsVo; }
			static OpVoAvxType OpVoAvx() { return &CX86Assembler::VcmpeqpsVo; }
		};
		...
		template <typename> void	Emit_Fp64_Avx_MemMem(const STATEMENT&);
		...
		void						Emit_Fp_Avx_NegD_MemMem(const STATEMENT&);
		...
		void						Emit_Fp_Avx_LdCst64_MemCst(const STATEMENT&);
		...
		void						Emit_Md_Avx_Mov_MemCst(const STATEMENT&);
		...
		void						Emit_Md_Avx2_ExpandB_VarCst(const STATEMENT&);
		...
		void						Emit_Md_Avx2_SllV_VarVarVar(const STATEMENT&);
		...
		void						Emit_Md_Avx_ExtractW_VarVarVar(const STATEMENT&);

		void						Emit_Md_Avx_ShuffleB_VarVarVar(const STATEMENT&);
		void						Emit_Md_Avx_PermuteB_MemMemMemMem(const STATEMENT&);
