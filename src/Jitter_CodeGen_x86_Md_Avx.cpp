...
void CCodeGen_x86::Emit_Md_Avx_ShuffleB_VarVarVar(const STATEMENT& statement)
{
	...
	auto src1Reg = PrepareSymbolRegisterUseMdAvx(src1, CX86Assembler::xMM1);

	m_assembler.VpshufbVo(dstReg, src1Reg, MakeVariable128SymbolAddress(src2));
...
CCodeGen_x86::CONSTMATCHER CCodeGen_x86::g_mdAvxConstMatchers[] = 
{
	...
	{ OP_MD_CMPEQ_S, MATCH_VARIABLE128, MATCH_VARIABLE128, MATCH_VARIABLE128, MATCH_NIL, &CCodeGen_x86::Emit_Md_Avx_VarVarVar<MDOP_CMPEQS> },
	...
	{ OP_MD_SQRT_S, MATCH_VARIABLE128, MATCH_VARIABLE128, MATCH_NIL, MATCH_NIL, &CCodeGen_x86::Emit_Md_Avx_VarVar<MDOP_SQRTS> },
